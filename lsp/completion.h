...
//
// 07 の 4 章. Three questions wear one request, and they are told apart by
...
//
// The other two are text. A half-written module path resolves to nothing,
// and an unterminated string is one error token running to the end of the
// file (lexer.c), so neither has a tree worth asking.
