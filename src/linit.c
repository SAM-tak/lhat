...
//
// If you embed L^ in your program and need to open the standard
...
//
// these libs are loaded by lhat.c and are readily available to any L^
// program
//
...
LHATLIB_API void lhatL_openlibs(lhat_State *L)
{
    ...
    for(const lhatL_Reg *lib = loadedlibs; lib->func; lib++) {
