...
void lhatT_callTM (lhat_State *L, const TValue *f, const TValue *p1,
  ...
  /* metamethod may yield only when called from Lhat code */
  if (isLhat(L->ci))
...
int lhatT_callbinTM (lhat_State *L, const TValue *p1, const TValue *p2,
                    StkId res, TMS event) {
...
void lhatT_trybinTM (lhat_State *L, const TValue *p1, const TValue *p2,
                    StkId res, TMS event) {
...
int lhatT_callorderTM (lhat_State *L, const TValue *p1, const TValue *p2,
                      TMS event) {
