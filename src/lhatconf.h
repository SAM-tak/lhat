/*
** $Id: lhatconf.h,v 1.259 2016/12/22 13:08:50 roberto Exp $
** Configuration file for Lhat
...
*/
#if defined(LHAT_COMPAT_5_2)	/* { */

/*
@@ LHAT_COMPAT_MATHLIB controls the presence of several deprecated
** functions in the mathematical library.
*/
#define LHAT_COMPAT_MATHLIB

/*
@@ LHAT_COMPAT_BITLIB controls the presence of library 'bit32'.
*/
#define LHAT_COMPAT_BITLIB

/*
@@ LHAT_COMPAT_IPAIRS controls the effectiveness of the __ipairs metamethod.
*/
#define LHAT_COMPAT_IPAIRS

/*
@@ LHAT_COMPAT_APIINTCASTS controls the presence of macros for
** manipulating other integer types (lhat_pushunsigned, lhat_tounsigned,
** lhatL_checkint, lhatL_checklong, etc.)
*/
#define LHAT_COMPAT_APIINTCASTS

#endif				/* } */


#if defined(LHAT_COMPAT_5_1)	/* { */
...
/*
@@ LHAT_COMPAT_UNPACK controls the presence of global 'unpack'.
** You can replace it with 'table.unpack'.
*/
#define LHAT_COMPAT_UNPACK

/*
@@ LHAT_COMPAT_LOADERS controls the presence of table 'package.loaders'.
** You can replace it with 'package.searchers'.
*/
#define LHAT_COMPAT_LOADERS

/*
@@ macro 'lhat_cpcall' emulates deprecated function lhat_cpcall.
** You can call your C function directly (with light C functions).
*/
#define lhat_cpcall(L,f,u)  \
	(lhat_pushcfunction(L, (f)), \
	 lhat_pushlightuserdata(L,(u)), \
	 lhat_pcall(L,1,0,0))


/*
@@ LHAT_COMPAT_LOG10 defines the function 'log10' in the math library.
** You can rewrite 'log10(x)' as 'log(x, 10)'.
*/
#define LHAT_COMPAT_LOG10

/*
@@ LHAT_COMPAT_LOADSTRING defines the function 'loadstring' in the base
** library. You can rewrite 'loadstring(s)' as 'load(s)'.
*/
#define LHAT_COMPAT_LOADSTRING

/*
@@ LHAT_COMPAT_MAXN defines the function 'maxn' in the table library.
*/
#define LHAT_COMPAT_MAXN
...
*/
#define lhat_strlen(L,i)		lhat_rawlen(L, (i))

#define lhat_objlen(L,i)		lhat_rawlen(L, (i))

#define lhat_equal(L,idx1,idx2)		lhat_compare(L,(idx1),(idx2),LHAT_OPEQ)
#define lhat_lessthan(L,idx1,idx2)	lhat_compare(L,(idx1),(idx2),LHAT_OPLT)

/*
@@ LHAT_COMPAT_MODULE controls compatibility with previous
** module functions 'module' (Lhat) and 'lhatL_register' (C).
*/
#define LHAT_COMPAT_MODULE
...
*/
/* #define LHAT_COMPAT_FLOATSTRING */
...
#if !defined(LHAT_USE_C89) && defined(__STDC_VERSION__) && \
...
/*
@@ LHAT_NOCVTN2S/LHAT_NOCVTS2N control how Lhat performs some
